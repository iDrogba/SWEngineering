...
export const EVENT_REVIEW_CREATE_REQUEST = 'EVENT_REVIEW_CREATE_REQUEST';
export const EVENT_REVIEW_CREATE_SUCCESS = 'EVENT_REVIEW_CREATE_SUCCESS';
export const EVENT_REVIEW_CREATE_FAIL = 'EVENT_REVIEW_CREATE_FAIL';
export const EVENT_REVIEW_CREATE_RESET = 'EVENT_REVIEW_CREATE_RESET';
...
export const EVENT_CATEGORY_LIST_FAIL = 'EVENT_CATEGORY_LIST_FAIL';

export const EVENT_TOPSELLERS_LIST_REQUEST = 'EVENT_TOPSELLERS_LIST_REQUEST';
export const EVENT_TOPSELLERS_LIST_SUCCESS = 'EVENT_TOPSELLERS_LIST_SUCCESS';
export const EVENT_TOPSELLERS_LIST_FAIL = 'EVENT_TOPSELLERS_LIST_FAIL';