          ...
          <ul>
            <li>
              <div className="card card-body">
                <h2>배송확인</h2>
                <p>
                  <strong>상품이름:</strong> {order.shippingAddress.fullName} <br />
                ...
                {order.isDelivered ? (
                  <MessageBox variant="success">
                    {order.deliveredAt}로 발송
                  </MessageBox>
                ) : (
                  <MessageBox variant="danger">아직 발송 안됨</MessageBox>
                )}
              </div>
            </li>
            <li>
              <div className="card card-body">
                ...
                {order.isPaid ? (
                  ...
                  <MessageBox variant="danger">아직 결제 안됨</MessageBox>
                )}
              </div>
            </li>
            <li>
